...
public class AuthController {
    ...
    public AuthResponse login(@RequestBody LoginRequest request) {
        ...
        return new AuthResponse(
                "Login réussi pour rôle : " + utilisateur.getRole().getNom(),
                accessToken,
    ...
    // ----------------- REFRESH TOKEN -----------------
    @PostMapping("/refresh")
    public ResponseEntity<?> refresh(@RequestParam String refreshTokenString) {
        ...
        return ResponseEntity.ok(new AuthResponse("Token renouvelé ✅", newAccessToken, refreshTokenString));
    }
